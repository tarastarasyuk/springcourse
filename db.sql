...
-- -----------------------------------------------------
-- Table `springcourse_template`.`opportunity_has_student`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `springcourse_template`.`opportunity_has_student` (
  `opportunity_id` INT NOT NULL,
  `student_id` INT NOT NULL,
  PRIMARY KEY (`opportunity_id`, `student_id`),
  INDEX `fk_opportunity_has_student_student1_idx` (`student_id` ASC),
  INDEX `fk_opportunity_has_student_opportunity1_idx` (`opportunity_id` ASC),
  CONSTRAINT `fk_opportunity_has_student_opportunity1`
    FOREIGN KEY (`opportunity_id`)
    REFERENCES `springcourse_template`.`opportunity` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_opportunity_has_student_student1`
    FOREIGN KEY (`student_id`)
    REFERENCES `springcourse_template`.`student` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
